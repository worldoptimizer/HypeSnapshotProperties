 ...
 * 1.0.1 Added ability to set props via options in the snapshot function
 */
...
if ("HypeSnapshotProps" in window === false) {
    window['HypeSnapshotProps'] = (function () {
         ...
         * @param {Object} [options] - Optional overrides for props values.
         */
        function snapshotProps(hypeDocument, element, options) {
            options = options || {};
            ...
            propsArray.forEach(function (prop) {
                var value = options[prop] !== undefined ? options[prop] : hypeDocument.getElementProperty(element, prop);
         ...
         * @param {Object} [options] - Optional overrides for props values.
         */
        function snapshotPropsAll(hypeDocument, selectorOrElement, options) {
            var elements = [];
            ...
            elements.forEach(function (element) {
                snapshotProps(hypeDocument, element, options);
            });
        }
        ...
        function HypeDocumentLoad(hypeDocument, element, event) {
            hypeDocument.snapshotProps = function (selectorOrElement, options) {
                snapshotPropsAll(hypeDocument, selectorOrElement, options);
            };
